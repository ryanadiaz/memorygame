$.merge(cards, cards); // Make 2 of each card inside the cards object
  ...
  shuffle().forEach(function(key) { // Display cards in a randomized order
    $('#cards').append('<section class="card-container"> <div class="card-block" data-id="' + cards[key].id + '"> <div class="card-front"> <img src="assets/images/union.png"> </div> <div class="card-back">' + '<img src="' + cards[key].image + '"> </div> </div> </section>');
  });
